...
const UserProfile = () => {
  return (
    <div className="bg-gray-100 my-20 shadow-lg p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-sm mx-auto rounded-lg transition-shadow duration-300 ease-in-out hover:shadow-xl">
      <img 
